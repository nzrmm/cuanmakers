<template>
  <div class="mb-12">
    ...
    <div class="mb-4 flex space-x-4">
      <ExploreButton>Live Action</ExploreButton>
      <ExploreButton>Art</ExploreButton>
      <ExploreButton>Photography</ExploreButton>
      <ExploreButton>Games</ExploreButton>
      <ExploreButton>Music</ExploreButton>
      <ExploreButton>Utility</ExploreButton>
    </div>
    ...
    <div class="flex flex-wrap -mx-3">
      ...
      <BaseCard src="images-4.png" alt="images-4" category="Art" timer="52h : 30m :23s" :curBid="8.25" title="Sparkam"/>
