<template>
  <aside class="w-[122px] min-h-screen bg-base">
    <div class="
        mb-[16px]
        h-[90px]
...
<style scoped>
  .list-item {
    @apply h-[84px] border-purple flex justify-center items-center transition-all
  }

  .list-item-hover {
    @apply hover:bg-white/10 hover:border-l-4
  }
</style>
